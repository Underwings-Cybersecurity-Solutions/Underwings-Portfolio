...
'iso-27001-certification-guide-uae',
...
$UWISO$,
'Compliance',
ARRAY['ISO 27001','certification','compliance','UAE','ISMS','Statement of Applicability'],
'ISO 27001 Certification UAE: Complete Implementation Guide | Underwings',
'How to get ISO 27001:2022 certified in the UAE: the mandatory clauses, the Statement of Applicability, Stage 1 and Stage 2 audits, the implementation journey, realistic timelines, and the mistakes that fail first attempts.',
'published',
'Manoj Prabhakaran',
NOW())
